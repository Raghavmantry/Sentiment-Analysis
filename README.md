# Sentiment Analysis ML Model Project
...
![Positive]([static\analysis.pn](https://github.com/Raghavmantry/Sentiment-Analysis/blob/main/static/analysis.png?raw=true)g)
